...
$GLOBALS['TL_LANG']['tl_form_field']['metamodel_notelist_notelist'][0]                = 'Note list';
$GLOBALS['TL_LANG']['tl_form_field']['metamodel_notelist_notelist'][1]                =
    'Select the note list for the different outputs.';
$GLOBALS['TL_LANG']['tl_form_field']['metamodel_notelist_rendersetting_frontend'][0]  = 'Form rendersettings';
$GLOBALS['TL_LANG']['tl_form_field']['metamodel_notelist_rendersetting_frontend'][1]  =
    'Select the rendersetting for the form output.';
$GLOBALS['TL_LANG']['tl_form_field']['metamodel_notelist_rendersetting_email'][0]     = 'Email rendersettings';
...
$GLOBALS['TL_LANG']['tl_form_field']['metamodel_notelist_rendersetting_clearlist'][1] =
    'Clear note list after form submit.';

$GLOBALS['TL_LANG']['tl_form_field']['metamodel_customTplEmail'][0] = 'Email template';
$GLOBALS['TL_LANG']['tl_form_field']['metamodel_customTplEmail'][1] =
    'Select the email template - this template encloses the output of the rendersetting for the email.';
